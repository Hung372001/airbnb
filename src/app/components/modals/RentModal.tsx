...
const RentModal = () => {
    ...
    let bodyContent = (
        <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-3 md:grid-cols-2 gap-3 max-h-[50vh] overflow-y-auto">
                {categories.map((item) => (
    ...
    if (step === STEPS.IMAGES) {
        bodyContent = (
            <div className="flex flex-col gap-8">
                <Heading title='Add photo off your place' subTitle="Show guests what your place look like"/>
                <ImageUpload
